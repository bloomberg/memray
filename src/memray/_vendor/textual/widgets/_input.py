...
from memray._vendor.textual.expand_tabs import expand_tabs_inline
...
from memray._vendor.textual.events import Blur, Focus, Mount
from memray._vendor.textual.geometry import Offset, Region, Size, clamp
from memray._vendor.textual.message import Message
from memray._vendor.textual.reactive import Reactive, reactive, var
from memray._vendor.textual.suggester import Suggester, SuggestionReady
from memray._vendor.textual.timer import Timer
from memray._vendor.textual.validation import ValidationResult, Validator
    ...
    def __init__(
        ...
        *,
        ...
        if not self.validators:
            from memray._vendor.textual.validation import Integer, Number
