...
from memray._vendor.textual._tree_sitter import TREE_SITTER, get_language
...
from memray._vendor.textual.document._syntax_aware_document import (
    SyntaxAwareDocument,
    SyntaxAwareDocumentError,
)
from memray._vendor.textual.document._wrapped_document import WrappedDocument
from memray._vendor.textual.expand_tabs import expand_tabs_inline, expand_text_tabs_from_widths
from memray._vendor.textual.screen import Screen
from memray._vendor.textual.style import Style as ContentStyle

if TYPE_CHECKING:
    from tree_sitter import Language, Query

from memray._vendor.textual import events, log
from memray._vendor.textual._cells import cell_len, cell_width_to_column_index
from memray._vendor.textual.binding import Binding
from memray._vendor.textual.events import Message, MouseEvent
from memray._vendor.textual.geometry import Offset, Region, Size, Spacing, clamp
from memray._vendor.textual.reactive import Reactive, reactive
from memray._vendor.textual.scroll_view import ScrollView
