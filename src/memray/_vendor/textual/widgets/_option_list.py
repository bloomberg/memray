...
from memray._vendor.textual import _widget_navigation, events
...
from memray._vendor.textual.css.styles import RulesMap
...
from memray._vendor.textual.visual import Padding, Visual, VisualType, visualize
