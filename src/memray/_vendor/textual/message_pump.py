...
from memray._vendor.textual import Logger, events, log, messages
from memray._vendor.textual._callback import invoke
from memray._vendor.textual._compat import cached_property
from memray._vendor.textual._context import NoActiveAppError, active_app, active_message_pump
from memray._vendor.textual._context import message_hook as message_hook_context_var
from memray._vendor.textual._context import prevent_message_types_stack
from memray._vendor.textual._on import OnNoWidget
from memray._vendor.textual._queue import Queue
from memray._vendor.textual._time import time
from memray._vendor.textual.constants import SLOW_THRESHOLD
from memray._vendor.textual.css.match import match
from memray._vendor.textual.events import Event
from memray._vendor.textual.message import Message
from memray._vendor.textual.reactive import Reactive, TooManyComputesError
from memray._vendor.textual.signal import Signal
from memray._vendor.textual.timer import Timer, TimerCallback

if TYPE_CHECKING:
    from typing_extensions import TypeAlias

    from memray._vendor.textual.app import App
    from memray._vendor.textual.css.model import SelectorSet
...
class MessagePump(metaclass=_MessagePumpMeta):
    ...
    if TYPE_CHECKING:
        from memray._vendor.textual import getters
