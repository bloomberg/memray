...
from memray._vendor.textual.keys import _get_key_aliases
...
if TYPE_CHECKING:
    ...
    from memray._vendor.textual.timer import Timer as TimerClass
    from memray._vendor.textual.timer import TimerCallback
