...
from memray._vendor.textual._loop import loop_last
from memray._vendor.textual.cache import FIFOCache
from memray._vendor.textual.color import Color
from memray._vendor.textual.css.types import TextAlign, TextOverflow
...
from memray._vendor.textual.visual import RenderOptions, RulesMap, Visual
...
class Content(Visual):
    ...
    def markup(self) -> str:
        ...
        """
        from memray._vendor.textual.markup import escape
    ...
    def from_markup(cls, markup: str | Content, **variables: object) -> Content:
        ...
        from memray._vendor.textual.markup import to_content
