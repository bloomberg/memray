...
from memray._vendor.textual._border import BorderValue, normalize_border_value
from memray._vendor.textual._cells import cell_len
from memray._vendor.textual._duration import _duration_as_seconds
from memray._vendor.textual._easing import EASING
from memray._vendor.textual.color import TRANSPARENT, Color, ColorParseError
from memray._vendor.textual.css._error_tools import friendly_list
from memray._vendor.textual.css._help_renderables import HelpText
from memray._vendor.textual.css._help_text import (
    align_help_text,
...
from memray._vendor.textual.css.constants import (
    HATCHES,
...
from memray._vendor.textual.css.model import Declaration
from memray._vendor.textual.css.scalar import (
    Scalar,
    ScalarError,
    ScalarOffset,
    ScalarParseError,
...
from memray._vendor.textual.css.styles import Styles
from memray._vendor.textual.css.tokenize import Token
from memray._vendor.textual.css.transition import Transition
from memray._vendor.textual.css.types import (
    BoxSizing,
    Display,
    EdgeType,
    Overflow,
...
from memray._vendor.textual.geometry import Spacing, SpacingDimensions, clamp
from memray._vendor.textual.suggestions import get_suggestion
...
class StylesBuilder:
    ...
    def process_layout(self, name: str, tokens: list[Token]) -> None:
        from memray._vendor.textual.layouts.factory import MissingLayout, get_layout
