...
from memray._vendor.textual._border import normalize_border_value
...
from memray._vendor.textual.css.constants import HATCHES, VALID_STYLE_FLAGS
from memray._vendor.textual.css.errors import StyleTypeError, StyleValueError
...
from memray._vendor.textual.geometry import NULL_SPACING, Spacing, SpacingDimensions, clamp

if TYPE_CHECKING:
    from memray._vendor.textual.canvas import CanvasLineType
    from memray._vendor.textual.layout import Layout
    from memray._vendor.textual.css.styles import StylesBase

from memray._vendor.textual.css.types import AlignHorizontal, AlignVertical, DockEdge, EdgeType
...
class LayoutProperty:
    ...
    def __set__(self, obj: StylesBase, layout: str | Layout | None):
        ...
        from memray._vendor.textual.layouts.factory import Layout  # Prevents circular import
        ...
        if value is None:
            ...
            if obj.set_rule(self.name, value):
                ...
                if self._pointer and obj.node is not None:
                    from memray._vendor.textual.dom import NoScreen
...
class OverflowProperty(StringEnumProperty):
    ...
    def _before_refresh(self, obj: StylesBase, value: str | None) -> None:
        from memray._vendor.textual.widget import Widget  # Avoid circular import
