...
from memray._vendor.textual.css._styles_builder import DeclarationError, StylesBuilder
from memray._vendor.textual.css.errors import UnresolvedVariableError
from memray._vendor.textual.css.model import (
    CombinatorType,
    Declaration,
    RuleSet,
    Selector,
...
from memray._vendor.textual.css.tokenize import (
    IDENTIFIER,
    Token,
    tokenize,
...
from memray._vendor.textual.css.tokenizer import ReferencedBy, UnexpectedEnd
from memray._vendor.textual.css.types import CSSLocation, Specificity3
