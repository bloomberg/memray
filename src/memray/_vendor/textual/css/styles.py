...
from memray._vendor.textual._types import AnimationLevel, CallbackType
from memray._vendor.textual.color import Color
from memray._vendor.textual.css._style_properties import (
    AlignProperty,
    BooleanProperty,
    BorderProperty,
    BoxProperty,
...
from memray._vendor.textual.css.scalar import Scalar, ScalarOffset, Unit
from memray._vendor.textual.css.scalar_animation import ScalarAnimation
...
from memray._vendor.textual.geometry import Offset, Spacing
...
class StylesBase:
    ...
    def parse(
        ...
        """
        from memray._vendor.textual.css.parse import parse_declarations
