...
from memray._vendor.textual.css.tokenizer import Expect, Token, Tokenizer
...
if __name__ == "__main__":
    ...
    from memray._vendor.textual._profile import timer

    with timer("tokenize"):
        list(tokenize_markup(text, read_from=("", "")))

    from memray._vendor.textual.markup import _parse
