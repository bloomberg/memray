...
from memray._vendor.textual.document._document import DocumentBase, Location
from memray._vendor.textual.expand_tabs import expand_tabs_inline, get_tab_widths
from memray._vendor.textual.geometry import Offset, clamp
