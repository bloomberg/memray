...
from memray._vendor.textual.containers import Center, Horizontal, ItemGrid, Vertical, VerticalScroll
from memray._vendor.textual.demo.page import PageScreen
from memray._vendor.textual.widgets import Footer, Label, Link, Markdown, Static
from memray._vendor.textual.demo._project_stars import STARS
from memray._vendor.textual.demo._project_data import PROJECTS, ProjectInfo
