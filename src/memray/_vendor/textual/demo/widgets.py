...
from memray._vendor.textual import containers, events, lazy, on
from memray._vendor.textual.app import ComposeResult
from memray._vendor.textual.binding import Binding
from memray._vendor.textual.demo.data import COUNTRIES, DUNE_BIOS, MOVIES, MOVIES_TREE
from memray._vendor.textual.demo.page import PageScreen
from memray._vendor.textual.reactive import reactive, var
from memray._vendor.textual.suggester import SuggestFromList
from memray._vendor.textual.theme import BUILTIN_THEMES
from memray._vendor.textual.widgets import (
    Button,
    Checkbox,
    DataTable,
    Digits,
...
"""
    ...
    DEFAULT_TEXT = """\
# Start building!
from memray._vendor.textual import App, ComposeResult
"""
